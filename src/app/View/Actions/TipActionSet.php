 ...
 * 역할]
 * - 화면별로 필요한 액션 목록을 구성
 * - 각 액션의 label, count, active, visible, endpoint, behavior 값을 정함
 * - blade 안에 긴 액션 배열이 흩어지지 않게 함.
 */
    ...
    public static function show(
        ...
        return [
            [
                ...
                'visible' => true,
                'behavior' => 'toggle',
                'endpoint' => route('tips.bookmark.toggle', $tip, false),
                'method' => 'POST',
            ],
            [
                'name' => 'like',
                ...
                'visible' => true,
                'behavior' => 'toggle',
                'endpoint' => route('tips.like.toggle', $tip, false),
                'method' => 'POST',
            ],
            [
                'name' => 'comment',
